    ...
    def __init__(self, tipo):
        ...
        if tipo == "PvP":
            ...
            opciones = [
                ...
                discord.SelectOption(label="Pequeña Escala", emoji="🛡️"),

                discord.SelectOption(label="Facciones", emoji="🏳️"),

                discord.SelectOption(label="Caminos", emoji="🛣️"),

                discord.SelectOption(label="Hellgate", emoji="🔥"),

                discord.SelectOption(label="Cristales de arena", emoji="💎"),

                discord.SelectOption(label="Competitivo (Crystal)", emoji="🏆"),

                discord.SelectOption(label="Castillos", emoji="🏰"),

                discord.SelectOption(label="Puestos avanzados", emoji="📍"),
            ...
            opciones = [
                ...
                discord.SelectOption(label="Caminos PvE", emoji="🛣️"),
